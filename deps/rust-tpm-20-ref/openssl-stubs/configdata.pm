...
unless (caller) {
    ...
    use lib '/home/ceping/vtpm-code/vtpm-td-open/deps/rust-tpm-20-ref/openssl/util/perl';
    use OpenSSL::fallback '/home/ceping/vtpm-code/vtpm-td-open/deps/rust-tpm-20-ref/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/ceping/vtpm-code/vtpm-td-open/deps/rust-tpm-20-ref/openssl/Configurations';
        use gentemplate;
